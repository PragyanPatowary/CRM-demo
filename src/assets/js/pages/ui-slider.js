var slider = document.getElementById("slider"),
  hidingTooltipSlider =
    ...
    document.getElementById("slider_2"));
...
for (
  var dateSlider = document.getElementById("slider-date"),
    ...
    select =
      (dateSlider.noUiSlider.on("update", function (e, t) {
...
var html5Slider = document.getElementById("html5"),
  ...
  skipSlider =
    ...
    document.getElementById("skipstep")),
  skipValues =
  ...
  pipsSlider =
    (skipSlider.noUiSlider.on("update", function (e, t) {
